...
Checkout it out live on [Github pages](https://arminhaghi.github.io/avro-docs-2.0/#/).
...
Clone the repo
    ...
    $ gitclone git@github.com:arminhaghi/avro-docs-2.0.git
...
* The [live](https://arminhaghi.github.io/avro-docs-2.0/#/) example is deployed using the guide above for github pages.
* The application expect the folder structure of the avro files to match the filenamespace, otherwise it won't find the schema to load. In the [live](https://arminhaghi.github.io/avro-docs-2.0/#/) example, the content of the `./public/avro` folder is the following:
```
